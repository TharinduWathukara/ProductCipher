...
public class Doencrypt {
     ...
     */
    public Doencrypt(String path,String key) throws FileNotFoundException,IOException{
...
//        create encryption
        Encryptdata encryptdata = new Encryptdata(readData,subs,permu);
        ArrayList<String> encrypted = encryptdata.getEncryptedData();

//       write data in text file
        Write write = new Write(filepath,encrypted);
